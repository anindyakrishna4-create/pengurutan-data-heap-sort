...
def heap_sort(data_list):
    ...
    # STATUS SELESAI DICATAT SETELAH LOOP FOR SELESAI
...
def _heapify_down(arr, n, i):
    ...
    if largest != i:
        ...
        HISTORY.append({
            'array': arr[:], 
            'highlight': (i, largest, 'Tukar Node'), 
